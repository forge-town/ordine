...
import {
  ...
  type NewSkillRow,
  type SkillRow,
} from "@/models/tables/skills_table";
    ...
    const seedData = [
      {
        ...
        label: "页面结构",
        description: "生成标准的页面 Anatomy：Wrapper + Content + 可选 Store，确保页面结构清晰分层。",
        category: "page",
      ...
      },
      {
        ...
        description: "在 React 组件中通过 Refine hooks 经由 DataProvider 访问数据，禁止直接调用 tRPC。",
        category: "data",
