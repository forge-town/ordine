  ...
  return (
    ...
    >
      <button
        ...
        title={isSidebarOpen ? t("canvas.collapseSidebar") : t("canvas.expandSidebar")}
      ...
      {isSidebarOpen && (
        <>
          <div className="border-b border-gray-100 px-4 py-3">
            <h2 className="text-sm font-semibold text-gray-700">{t("canvas.nodeLibrary")}</h2>
            <p className="mt-0.5 text-xs text-gray-400">{t("canvas.clickToAdd")}</p>
          </div>
          ...
          <div className="border-t border-gray-100 p-3">
            <p className="text-center text-[10px] text-gray-400">{t("canvas.connectNodesHint")}</p>
          </div>
        </>
      )}
    </div>
