...
describe("ConditionNode", () => {
  it("renders label", () => {
    render(<ConditionNode id="1" data={baseData} />, { wrapper });
  ...
  it("renders placeholder when expression is empty", () => {
    render(<ConditionNode id="1" data={{ ...baseData, expression: "" }} />, {
      wrapper,
    });
  ...
  it("shows status label for each status", () => {
    const { rerender } = render(
      <ConditionNode id="1" data={{ ...baseData, status: "idle" }} />,
      { wrapper },
    );
    ...
    rerender(
      <HarnessCanvasStoreProvider>
        <ReactFlowProvider>
          <ConditionNode id="1" data={{ ...baseData, status: "pass" }} />
        </ReactFlowProvider>
      </HarnessCanvasStoreProvider>,
    );
    ...
    rerender(
      <HarnessCanvasStoreProvider>
        <ReactFlowProvider>
          <ConditionNode id="1" data={{ ...baseData, status: "fail" }} />
        </ReactFlowProvider>
      </HarnessCanvasStoreProvider>,
    );
