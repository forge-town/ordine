...
The open-source AI Agent-first meta-orchestration engine.<br/>
...
Ordine is an **AI Agent-first meta-orchestration engine** that lets you define typed operations, compose them into DAG pipelines, and execute them with any AI agent or script executor.
