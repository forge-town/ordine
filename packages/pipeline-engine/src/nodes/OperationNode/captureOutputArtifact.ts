 ...
 *
 * Known limitations: the artifact records only the directory plus a file list (paths, not
 * per-file data contracts), and files reachable only through symlinks are not listed.
 */
