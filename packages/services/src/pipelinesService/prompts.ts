...
export const buildGenerateSystemPrompt = (skillReferences: string): string =>
  [
    ...
    "- Arrange nodes LEFT TO RIGHT by dependency depth with ~400px horizontal spacing. Put independent parallel siblings at the same x and separate them vertically.",
    "- Derive edges from real data dependencies. Never chain independent operations merely because they appear in a list.",
