    ...
    <div className="space-y-1.5" data-testid="agent-checkpoint">
      <div className="flex items-center gap-1.5 text-[11px] text-muted-foreground">
        ...
        <span className="truncate">
          {isWaiting
            ? t("canvas.agentPanel.checkpoint.waiting", {
                node: nodeLabel ?? t("canvas.agentPanel.checkpoint.nextNode"),
              })
            : t("canvas.agentPanel.checkpoint.controls")}
        </span>
      </div>
      <div className="flex items-center gap-1.5">
        ...
        >
          ...
          {t("canvas.agentPanel.checkpoint.pause")}
        </Button>
        <Button
          className="h-6 rounded-lg px-2 text-[11px]"
        ...
        >
          ...
          {t("canvas.agentPanel.checkpoint.resume")}
        </Button>
        {isWaiting && onReview ? (
          <Button
            className="h-6 rounded-lg px-2 text-[11px]"
          ...
          >
            ...
            {t("canvas.agentPanel.checkpoint.review")}
          </Button>
        ) : null}
      </div>
    </div>
